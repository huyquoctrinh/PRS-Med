...
# from segment_model.model_concat import build_llm_seg
...
def evaluate(model, val_loader, device="cuda:1"): 
    dice_score_list = []
...
def train(
    ...
    for epoch in range(num_epochs):
        ...
        for batch in progress_bar:
            ...
            with autocast(dtype=torch.float16, device_type="cuda:1"):
            ...
            loss = segment_loss + cls_loss + logit_loss 
        ...
        model.save_model(f"/home/mamba/ML_project/Testing/Huy/llm_seg/training_results/llava15_seg/llm_seg_{epoch+1}")
        # break
...
model.load_model("/home/mamba/ML_project/Testing/Huy/llm_seg/training_results/llava15_seg/llm_seg_10")
