...
def load_model():
    ...
    # model = model.to("cpu")
    tokenizer = model.load_model("/home/mamba/ML_project/Testing/Huy/llm_seg/training_results/train_sam_med_llava_med/llm_seg_4")
...
if __name__ == "__main__":
    ...
    results_path = "results/lm_seg_test_3_full_6_classes_16_benchmark_sam_train/"
