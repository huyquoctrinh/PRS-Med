...
def process_question(question: str, answer: str, groundtruth:str) -> str:
    ...
    Question: {question} | Groundtruth: {groundtruth} | Answer: {answer}
...
def benchmark(df_path_res, df_path_gt):
    ...
    df_res = pd.read_csv(df_path_res)
...
if __name__ == "__main__":
    df_res_path = "/home/mamba/ML_project/Testing/Huy/llm_seg/results/lm_seg_test_3_full_2_ckpt_15/"
