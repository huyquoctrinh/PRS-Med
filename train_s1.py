...
logging.basicConfig(
    filename='logs/training_seg.log',
    level=logging.INFO,
    ...
    for epoch in range(num_epochs):
        ...
        for batch in progress_bar:
            ...
            if progress_bar.n % 1000 == 0:
                logging.info(f"Epoch [{epoch+1}/{num_epochs}], Step [{progress_bar.n}], Loss: {avg_loss}, LLM Loss: {avg_llm_loss}, Cls Loss: {avg_cls_loss}")
            progress_bar.set_postfix(loss=avg_loss, avg_llm_loss=avg_llm_loss, cls_loss=avg_cls_loss)
        ...
        model.save_model(f"/home/mamba/ML_project/Testing/Huy/llm_seg/training_results/weights3_full_s1/llm_seg_{epoch+1}")
        # break
...
# model.load_model("/home/mamba/ML_project/Testing/Huy/llm_seg/training_results/weights3_full/llm_seg_15")
